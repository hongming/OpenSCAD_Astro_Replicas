...
[60,50] 
    ...
    translate([130,70]){
            polygon(points=[
            [0,0],
            [quilateral_triangle_length,0],
            [quilateral_triangle_length/2,quilateral_triangle_length*cos(45)],
            ]);
    }
    //底部圆形空缺-大
    translate([320,160])
...
//三角形漏洞组
        ...
        color("green")
          ...
          //近端从下数第二个三角形
         translate([340+5+5+10+10,400+10+10/5+2*quilateral_triangle_length+10+20,0])
        rotate([0,0,270])
        color("red")
                        polygon(points=[
                    [0,0],
 ...
 */
 ...
 module rasa11_array(){
   ...
   /*  
     rotate([0,0,90-rasa_array_angle]){
